...
% randex = randperm(n, m);
% 
% y_train = [bpen(randex,:); bpen1(randex,:); bpen2(randex,:); bpen3(randex,:)];
% 
...
% X_train = [bpfr(randex,:); bpfr1(randex,:); bpfr2(randex,:); bpfr3(randex,:)];
% N_train = length(y_train);
% clear bpfr bpfr1 bpfr2 bpfr3;
% 
% name = "IWSLT17.TED.tst2015_fr";
% tstfr = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bpe.fr');
% tstfr1 = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bped_1.fr');
% tstfr2 = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bped_2.fr');
% tstfr3 = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bped_3.fr');
...
% 
% X_test = [tstfr; tstfr1; tstfr2; tstfr3];
% y_test = [tsten; tsten1; tsten2; tsten3];
...
% theta = xtheta;
% save( 'frentrain_1k_theta.mat', 'xtheta', '-v7.3');
% 
% y_hat = X_test*theta;
