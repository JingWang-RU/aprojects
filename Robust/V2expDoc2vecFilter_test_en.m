...
deven = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bpe.en');
deven1 = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bped_1.en');
deven2 = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bped_2.en');
deven3 = csvread('./doc2vec/IWSLT17.TED.tst2015.en-fr.tok.tc.bped_3.en');
[n, dim] = size(deven);
